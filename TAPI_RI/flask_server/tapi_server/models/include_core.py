...
class IncludeCore(Model):
    """NOTE: This class is auto generated by the swagger code generator program.

    Do not edit the class manually.
    """

    def __init__(self, core_id: str=None, selected_frequency_slot: List[FrequencySlot]=None ):  # noqa: E501
        ...
        self.swagger_types = {
            'core_id': str,
            'selected_frequency_slot': List[FrequencySlot]
        }

        self.attribute_map = {
            'core_id': 'core-id',
            'selected_frequency_slot': 'available-frequency-slot'
        }

        self._core_id = core_id
        self._selected_frequency_slot = selected_frequency_slot

    @classmethod
    def from_dict(cls, dikt) -> 'IncludeCore':
    ...
    @property
    def selected_frequency_slot(self) -> List[FrequencySlot]:
        ...
        """
        return self._selected_frequency_slot

    @selected_frequency_slot.setter
    def selected_frequency_slot(self, selected_frequency_slot: List[FrequencySlot]):
